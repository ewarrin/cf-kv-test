...
export default defineEventHandler(async (event) => {
    ...
    try {
        ...
        console.log(`🔍 Checking KV for cached search results: ${cacheKey}`);
        let cachedResults = await kv.get(cacheKey);

        if (cachedResults) {
            console.log("🎯 Returning cached search results from KV");
        ...
        console.log(`💾 Caching search results in KV: ${cacheKey}`);
